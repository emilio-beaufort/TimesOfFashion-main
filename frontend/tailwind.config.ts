	...
	theme: {
		...
		extend: {
			...
			colors: {
				...
				// Fashion Magazine Custom Colors
				pastel: {
			...
			backgroundImage: {
				...
				'gradient-deep-luxury-red': 'var(--gradient-deep-luxury-red)',
				'gradient-crimson-glow': 'var(--gradient-crimson-glow)',
				'gradient-red-gold-accent': 'var(--gradient-red-gold-accent)',
				'gradient-velvet-depth': 'var(--gradient-velvet-depth)'
			},
			boxShadow: {
